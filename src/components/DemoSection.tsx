...
import { Play, Pause, FileText, CheckCircle2, Copy, Download, RefreshCw, Wand2, Mic, MessageSquare, FileJson, Loader2, UploadCloud, FileAudio } from 'lucide-react';
import { useState, useEffect, useRef } from 'react';

const MOCK_TRANSCRIPT = [
  { time: 0, speaker: '個管師', text: '伯伯，最近腳有比較好嗎？上次跌倒的地方還會痛嗎？' },
  { time: 35, speaker: '陳伯伯', text: '有啦，比較消腫了，但是走路還是會怕怕的 (台語)。' }, // 35% progress
  { time: 70, speaker: '個管師', text: '那藥有沒有按時吃？血壓這幾天量多少？' }, // 70% progress
];

const MOCK_SOAP = `## S (主觀評估)
